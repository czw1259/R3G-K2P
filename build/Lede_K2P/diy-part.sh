...
sed -i "/uci commit network/i\uci set network.lan.ipaddr='192.168.4.4'" $ZZZ                       # IPv4 地址(openwrt后台地址)
...
sed -i 's/PATCHVER=5.10/PATCHVER=5.15/g' target/linux/Makefile/Makefile                               # 修改内核版本为4.19
